...
public class ReligiAdapter extends RecyclerView.Adapter<ReligiAdapter.MyViewHolder> implements Filterable {

    Context mContext;
    List<Religis> mData;
    List<Religis> mDataAll;

    public ReligiAdapter(Context mContext, List<Religis> mData) {

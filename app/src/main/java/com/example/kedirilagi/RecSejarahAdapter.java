...
public class RecSejarahAdapter extends RecyclerView.Adapter<RecSejarahAdapter.MyViewHolder> implements Filterable {

    Context mContext;
    List<Sejarahs> mData;
    List<Sejarahs> mDataAll;

    public RecSejarahAdapter(Context mContext, List<Sejarahs> mData) {

...
public class AlamAdapter extends RecyclerView.Adapter<AlamAdapter.MyViewHolder> implements Filterable {
    ...
    public AlamAdapter(Context mContext, List<Alams> mData) {

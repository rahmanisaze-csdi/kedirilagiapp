...
public class SearchCafeAdapter extends RecyclerView.Adapter<SearchCafeAdapter.MyViewHolder> implements Filterable {

    Context mContext;
    List<Cafes> mData;
    List<Cafes> mDataAll;

    public SearchCafeAdapter(Context mContext, List<Cafes> mData) {

...
public class RecReligiAdapter extends RecyclerView.Adapter<RecReligiAdapter.MyViewHolder> implements Filterable {

    Context mContext;
    List<Religis> mData;
    List<Religis> mDataAll;

    public RecReligiAdapter(Context mContext, List<Religis> mData) {

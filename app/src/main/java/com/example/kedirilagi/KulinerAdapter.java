...
public class KulinerAdapter extends RecyclerView.Adapter<KulinerAdapter.MyViewHolder> implements Filterable {

    Context mContext;
    List<Kuliners> mData;
    List<Kuliners> mDataAll;

    public KulinerAdapter(Context mContext, List<Kuliners> mData) {

...
public class CafeAdapter extends RecyclerView.Adapter<CafeAdapter.MyViewHolder> implements Filterable {

    Context mContext;
    List<Cafes> mData;
    List<Cafes> mDataAll;

    public CafeAdapter(Context mContext, List<Cafes> mData) {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    cafeDetailActivity.putExtra("igLink", mData.get(position).getIgLink());

...
public class RecAlamAdapter extends RecyclerView.Adapter<RecAlamAdapter.MyViewHolder> implements Filterable {
    ...
    public RecAlamAdapter(Context mContext, List<Alams> mData) {
